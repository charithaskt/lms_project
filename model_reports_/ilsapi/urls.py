...
from .views import BibliosByTitleListView, BibliosByRangeListView, ProfileList, MySuggestionsListView
...
urlpatterns = [
    ...
    path('biblios/byrange/<str:begin>/', BibliosByRangeListView.as_view(), name="biblios-byrange-list"),
    ...
    path('mysuggestions/', MySuggestionsListView.as_view(), name="mysuggestions"),
    #--------
    path('borrowers/',api_views.ListCreateBorrowersView.as_view(), name="borrowers-list-create"),
